...
public class PvpBotQueue implements CommandExecutor {
...
//        Inventory gui = Bukkit.createInventory(null, 45, ChatColor.DARK_PURPLE + "Queue Selection");
        Inventory gui = Bukkit.createInventory(null, 45, ChatColor.DARK_RED.toString() + ChatColor.BOLD + "COMING SOON WITH ADVANCED AI");
